...
<div class="w-nav-button hamburger"><div class="w-icon-nav-menu"></div></div></div></div><div class="w-hidden-medium w-hidden-small w-hidden-tiny sns-shrink"></div><div class="map"><div class="w-widget w-widget-map" data-widget-latlng="45.857171, 6.618043" data-widget-style="terrain" data-widget-zoom="16" data-disable-scroll="1"></div></div><div class="w-section section gray"><div class="w-container"><div class="w-form">

<form class="w-clearfix" id="email-form" name="email-form" data-name="Email Form">

<input class="w-input text-filed" id="name" type="text" placeholder="Nom" name="name" data-name="Name" required>
<input class="w-input text-filed no-l" id="name" type="text" placeholder="Prénom" name="name" data-name="Name" required>
<input class="w-input text-filed" id="Email-2" type="email" placeholder="Adresse email" name="Email" data-name="Email" required>

<input class="w-input text-filed no-l" id="Subjet" type="text" placeholder="Téléphone" name="Subjet" data-name="Subjet">

<textarea class="w-input text-filed _100-p are" id="Area" placeholder="Votre message" name="Area" data-name="Area" required></textarea>
...
<footer class="w-section footer"><div class="bottom-footer"><div class="w-container cont-center"><p class="p-footer">Création du site : <a href="http://www.remyperret.com" target="_blank">Rémy PERRET </a></p></div></div>
	...
	<div class="w-container">
		...
		<div class="w-col w-col-4"><div><h1 class="top-footer">Contact info</h1></div><div class="div-spc"><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;contact@vivremegeve.fr<br><strong>Adresse:</strong>&nbsp;&nbsp;&nbsp;&nbsp;BP 23, 1 place de l'Eglise<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;74120 MEGEVE&nbsp;</p></div></div></div>
