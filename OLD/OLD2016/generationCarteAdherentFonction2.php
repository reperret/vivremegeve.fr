...
function generateCarteUtilisateur($idUtilisateur)
{
...
<style type="text/css">
<!--
    div.zone { border: none; border-radius: 6mm; background: #0e3356; border-collapse: collapse; padding:2mm; font-size: 2.7mm;}
            ...
            <td style="width: 100%">
                <div class="zone" style="height: 53mm;position: relative;font-size: 5mm;">
                    ...
                    <div style="position: absolute; left: 28mm; top: 41mm; text-align: left; font-size: 3mm;color:#FFF ">
                       <b>N° Carte résident :</b> <?php echo $numResident;?><br>
                    </div>
                    
                    
                     <div style="position: absolute; left: 28mm; top: 46mm; text-align: left; font-size: 3mm; color:#FFF ">
                       <b>Date validité :</b> 31/08/2016<br>
                    </div>
                    
                     <div style="position: absolute; left: 75mm; top: 45mm; text-align: left; font-size: 5mm; color:#FFF ">
                       TS<?php  //echo $date->format('d/m/Y') ;?><br>
                    </div>
...
<?php
    ...
    {	
		...
		$req = $dbh->prepare('UPDATE utilisateur SET urlCarte=? WHERE idUtilisateur=?');
		$req->execute(array($nomFacture2,intval($idUtilisateur)));
