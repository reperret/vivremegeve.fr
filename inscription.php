...
try {
    ...
    if (isset($_POST['inscription']) && $_POST['inscription'] == 'Inscription') {
        ...
        if (
            ...
            if ($_POST['pass'] != $_POST['pass_confirm']) {
                ...
                if ($loginExistant == 0  && $checkDoublon == 0 && $codeMairie) {
                    ...
                    $reqInsert->bindParam(24, $rgpd_vivre_megeve);
                    $reqInsert->bindParam(25, $rgpd_mairie_megeve);
		...
		En attendant, vous pouvez accéder à votre espace client en cliquant ci dessous sur le bouton.<br><br>
		...
		La présidente, Annick SOCQUET CLERC.";
                        ...
                        $envoi = sendMail($email, "Confirmation inscription", $body, "Accès espace adhérent", "https://www.vivremegeve.fr/compteclient.php", "6330280", "confirmation inscription", NULL);
        ...
        <div class="w-section section s-2">
            <div class="w-container">
                ...
                <div class="div-tittle">
                    ...
                    <h2><strong> ATTENTION </strong>: si vous souhaitez renouveler votre adhésion, et que vous possédez
                        donc DEJA un compte, veuillez vous connecter à votre <a href="compteclient.php">espace
                            adhérent</a></h2>


                </div>
                <center><u>Les informations ci dessous ne seront pas diffusées</u><br> Une inscription sur cette page
                    correspondant à une et une seule personne physique. Vous pouvez créer différents comptes avec
                    différents pseudonymes tout en utilisant une même adresse email.<br><br>
                    <strong><u>Le pseudonyme que vous devez choisir est libre, c'est vous qui l'inventez. Il ne doit pas
                            comporter d'espace ni d'accent. (exemple : "toto74skieur")</u></strong>
                </center><br><br>
                    ...
                    <form action="inscription.php" method="post" class="pure-form pure-form-aligned">
                        <fieldset>
                            ...
                            <div class="pure-control-group">
                                ...
                                <input type="text" placeholder="Pseudonyme" name="login" value="<?php if (isset($_POST['loginInscription'])) {
                                                                                                        echo htmlentities(utf8_decode(trim($_POST['loginInscription'])));
                                                                                                    } elseif (isset($_POST['login'])) {
                                                                                                        echo htmlentities(utf8_decode(trim($_POST['login'])));
                                                                                                    } ?>"
                                    onkeyup="verifLogin(this);" required>
                            </div>
                            ...
                            <div class="pure-control-group">
                                ...
                                <input type="text" placeholder="Nom" name="nom"
                                    value="<?php if (isset($_POST['nom'])) echo htmlentities(utf8_decode(trim($_POST['nom']))); ?>"
                                    required>
                            </div>
                            ...
                            <div class="pure-control-group">
                                ...
                                <input type="text" placeholder="Prenom" name="prenom"
                                    value="<?php if (isset($_POST['prenom'])) echo trim($_POST['prenom']); ?>" required>
                            </div>
                            ...
                            <div class="pure-control-group">
                                ...
                                <select name="jour" style="width:60px">
                                    ...
                                    <?php
                                        for ($i = 1; $i <= 31; $i++) {
                                            if (strlen($i) == 1) { ?>
                                    <option value="0<?php echo $i; ?>"
                                        <?php if ($_POST['jour'] == "0" . $i) echo "selected"; ?>>0<?php echo $i; ?>
                                    </option>
                                    <?php
                                            } else {
                                            ?>
                                    <option value="<?php echo $i; ?>"
                                        <?php if ($_POST['jour'] == $i) echo "selected"; ?>><?php echo $i; ?></option>
                                    <?php
                                            }
                                        }
                                        ?>
                                ...
                                <select name="mois" style="width:80px">
                                    <option value=""></option>
                                    <option value="01" <?php if ($_POST['mois'] == "01") echo "selected"; ?>>Janvier
                                    </option>
                                    <option value="02" <?php if ($_POST['mois'] == "02") echo "selected"; ?>>Février
                                    </option>
                                    <option value="03" <?php if ($_POST['mois'] == "03") echo "selected"; ?>>Mars
                                    </option>
                                    <option value="04" <?php if ($_POST['mois'] == "04") echo "selected"; ?>>Avril
                                    </option>
                                    <option value="05" <?php if ($_POST['mois'] == "05") echo "selected"; ?>>Mai
                                    </option>
                                    <option value="06" <?php if ($_POST['mois'] == "06") echo "selected"; ?>>Juin
                                    </option>
                                    <option value="07" <?php if ($_POST['mois'] == "07") echo "selected"; ?>>Juillet
                                    </option>
                                    <option value="08" <?php if ($_POST['mois'] == "08") echo "selected"; ?>>Août
                                    </option>
                                    <option value="09" <?php if ($_POST['mois'] == "09") echo "selected"; ?>>Septembre
                                    </option>
                                    <option value="10" <?php if ($_POST['mois'] == "10") echo "selected"; ?>>Octobre
                                    </option>
                                    <option value="11" <?php if ($_POST['mois'] == "11") echo "selected"; ?>>Novembre
                                    </option>
                                    <option value="12" <?php if ($_POST['mois'] == "12") echo "selected"; ?>>Décembre
                                    </option>
                                </select>
                                <select name="annee" style="width:80px">
                                    ...
                                    <option value="<?php echo $i; ?>"
                                        <?php if ($_POST['annee'] == $i) echo "selected"; ?>><?php echo $i; ?></option>
                            ...
                            <div class="pure-control-group">
                                ...
                                <input type="password" placeholder="Confirmer Mot de passe" name="pass_confirm"
                                    value="<?php if (isset($_POST['pass_confirm'])) echo htmlentities(trim($_POST['pass_confirm'])); ?>"
                                    required>
                            ...
                            <div class="pure-control-group">
                                ...
                                <input type="text" placeholder="Téléphone" name="telephone"
                                    value="<?php if (isset($_POST['telephone'])) echo htmlentities(trim($_POST['telephone'])); ?>"
                                    required>
                            </div>
                            ...
                            <div class="pure-control-group">
                                ...
                                <textarea type="text" placeholder="Adresse"
                                    name="adresse"><?php if (isset($_POST['adresse'])) echo htmlentities(utf8_decode(trim($_POST['adresse']))); ?></textarea>

                                <br><br><span class="red"> [ ! ] attention, si vous êtes résident secondaire, commerçant
                                    permanent, ou Travailleur/Saisonnier<br> merci d'indiquer votre adresse
                                    <strong>principale</strong> [ ! ]</span><br><br>
                            ...
                            <div class="pure-control-group">
                                ...
                                <input type="text" placeholder="Code postal" name="code_postal"
                                    value="<?php if (isset($_POST['code_postal'])) echo htmlentities(utf8_decode(trim($_POST['code_postal']))); ?>"
                                    required>
                            ...
                            <div class="pure-control-group">
                                ...
                                <input type="text" placeholder="Ville" name="ville"
                                    value="<?php if (isset($_POST['ville'])) echo htmlentities(utf8_decode(trim($_POST['ville']))); ?>"
                                    required>
                            ...
                            <div class="pure-control-group">
                                ...
                                <textarea type="text" placeholder="Adresse secondaire"
                                    name="adresse2"><?php if (isset($_POST['adresse2'])) echo htmlentities(utf8_decode(trim($_POST['adresse2']))); ?></textarea>
                            ...
                            <div class="pure-control-group">
                                ...
                                <input type="text" placeholder="Code postal secondaire" name="code_postal2"
                                    value="<?php if (isset($_POST['code_postal2'])) echo htmlentities(utf8_decode(trim($_POST['code_postal2']))); ?>">

                            </div>
                            <div class="pure-control-group">
                                <label for="ville2">Ville secondaire</label>

                                <input type="text" placeholder="Ville secondaire" name="ville2"
                                    value="<?php if (isset($_POST['ville2'])) echo htmlentities(utf8_decode(trim($_POST['ville2']))); ?>">
                            ...
                            <br><br><span class="red"> [ ! ] Merci de bien vouloir être vigilant lors de la sélection de
                                votre statut, en cas d'erreur, les forfaits pourront être bloqués [ ! ]</span><br><br>

                            <div class="pure-control-group">
                                <label for="numResident">Numéro *</label>
                                01- <input type="text" name="numResident"
                                    value="<?php if (isset($_POST['numResident'])) echo htmlentities(utf8_decode(trim($_POST['numResident']))); ?>"
                                    onkeyup="verif_nombre20(this);" onchange="validerTaille(this);" size="20" required>
                                -
                                <input type="text" name="numResident2"
                                    value="<?php if (isset($_POST['numResident2'])) echo htmlentities(utf8_decode(trim($_POST['numResident2']))); ?>"
                                    onkeyup="verif_nombre1(this);" size="1" required>
                            ...
                            <div class="pure-control-group">
                                ...
                                <input type="text" name="codeMairie"
                                    value="<?php if (isset($_POST['codeMairie'])) echo htmlentities(utf8_decode(trim(strtoupper($_POST['codeMairie'])))); ?>"
                                    required>
                            ...
                            <div class="pure-control-group">
                                ...
                                <select name="typeAdherent">
                                    <option value="RP" <?php if ($_POST['typeAdherent'] == "RP") echo "selected"; ?>>
                                        Résident permanent</option>
                                    <option value="RS" <?php if ($_POST['typeAdherent'] == "RS") echo "selected"; ?>>
                                        Résident secondaire</option>
                                    <option value="TS" <?php if ($_POST['typeAdherent'] == "TS") echo "selected"; ?>>
                                        Travailleur/Saisonnier</option>
                                    <option value="CP" <?php if ($_POST['typeAdherent'] == "CP") echo "selected"; ?>>
                                        Commerçant permanent</option>
                                </select>
                            ...
                            <center>
                                <p>
                                    ...
                                    2. Veuillez choisir une photo de moins de <strong>700 Ko</strong>, faisant
                                    apparaitre vos visage.<br>
                                    2. Vous pouvez la recadrer en zoomant (+), dézoomant (-), etc...<br>
                                    3. <strong><u>N'oubliez pas</u></strong> de cliquer sur <img
                                        src="images/confirmer.png"> pour finaliser l'ajout de la photo<br><br><br>
                            ...
                            <div class="choixPaiement">
                                <label for="paiementCB" class="pure-radio">
                                    ...
                                    Payer par <u>CARTE BANCAIRE</u> en ligne (conseillé : votre inscription est
                                    instantanée)<br>
                                ...
                                <label for="paiementCheque" class="pure-radio">
                                    <input id="paiementCheque" type="radio" name="choixPaiement" value="cheque"
                                        <?php if ($_POST['choixPaiement'] == "cheque") echo " checked"; ?>>
                                    Envoyer un <u>CHEQUE de <?php echo $montantAnneeEnCours; ?>€ par la poste</u> (votre
                                    inscription n'est effective qu'à l'encaissement de votre chèque)
                                </label>
                            </div>
                            ...
                            <center>
                                ...
                                <div id="recaptcha" class="g-recaptcha"
                                    data-sitekey="6LdC8hcTAAAAALai9tRHxOpbruUt41_BElgMm3aX"></div>
                            </center>
                            <br><br> <br><br>

                            <button type="submit" name="inscription" value="Inscription"
                                class="pure-button primary-button button-success">Valider votre inscription</button>
