<?php
function generateCarteUtilisateur($idUtilisateur, $sortie, $numAdherent,$dbh)
{
	$nom=NULL;
	$prenom=NULL;
	$dateAdhesion=NULL;
...
<style type="text/css">
    ...
    div.zone {
        border: none;
        border-radius: 6mm;
        background: <?php echo $couleurCarte;
        ?>;
            ...
            <td style="width: 100%">
                <div class="zone" style="height: 53mm;position: relative;font-size: 5mm;">
                    ...
                    <div style="position: absolute; right: 20mm; top: 9mm; text-align: right; font-size: 8mm;  color:#FFF">
                        <img src="<?php echo $_SERVER['DOCUMENT_ROOT']."/images/logoCarte.png";?>" width="200">
                    </div>
                    ...
                    <div style="position: absolute; left: 28mm; top: 49mm; text-align: left; font-size: 3mm; color:#FFF ">
                        <b>Date validité :</b> 31/08/2025<br>
                    </div>
                    ...
                    <div style="position: absolute ; left: 5mm; top: 30%; vertical-align: middle;text-align: center;">
						...
						{
						?>
                        <img src="<?php echo $_SERVER['DOCUMENT_ROOT']."/avatars/silouette.jpg";?>">
                        <?php
						} ?>
...
<?php
    ...
    {	
		...
		{
						$html2pdf->Output($_SERVER['DOCUMENT_ROOT']."/cartesGenerees/".$nomFacture2, "F");
		}
