        ...
        for($j=$start; $j<$end; $j++) 
        {
            ...
            elseif($trOuvrant)
            {
             ...
             if($trOuvrant){  $trOuvrant=false;} 
                        ...
                        ?><div style="rotate:90;margin:0px;padding:0px;text-align:center;font-size:8px;color: #984807;   position: absolute;  top: <?php echo $yInit;?>px;  left: <?php echo $xOffset[$nbElementsParLigne];?>px; ">www.cabaneajeux.fr<br><barcode type="C39" value="<?php echo $numAdherentSimule;?>A"  label="label" style="width:27mm; height:8mm; color: #000; font-size: 2.5mm; font-weight: bold; margin:auto;color: #984807;" ></barcode></div><?php
