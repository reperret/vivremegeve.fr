...
<form class="pure-form pure-form-aligned" action="editerMembrePost.php" method="post">
    ...
    <div class="pure-control-group">
        ...
        <input id="option-two" type="radio" name="civilite" value="Monsieur" <?php if($civilite=="Monsieur") echo "checked"; ?>>
        Homme
   
   
        <input id="option-three" type="radio" name="civilite" value="Madame" <?php if($civilite=="Madame") echo "checked"; ?>>
        Femme
         ...
         <select name="typeAdherent">
            ...
            <option value="RP" <?php// if($typeAdherent=="RP"){ echo "selected";} ?>>Résident permanent</option>
            <option value="RS" <?php //if($typeAdherent=="RS"){ echo "selected";} ?>>Résident secondaire</option>
            <option value="TS" <?php //if($typeAdherent=="TS"){ echo "selected";} ?>>Travailleur/Saisonnier</option>
        </select>
...
-->
	...
	<div class="pure-control-group">
	 <label for="state">Email</label>
		 ...
		 <label for="state">Mot de passe</label>
            ...
            <input type="password" placeholder="Mot de passe" name="pass" value="MPD_IMPROBABLEHUHUHU">
        </div>
		 ...
		 <label for="state">Confirmer MDP</label>
            ...
            <input type="password" placeholder="Confirmer Mot de passe" name="pass_confirm" value="MPD_IMPROBABLEHUHUHU">
        </div>
 ...
 <label for="prenom">Prénom</label>
	...
	<div class="pure-control-group">
		 ...
		 <label for="adresse">Adresse</label>
           ...
           <textarea name="adresse" value="<?php echo $adresse; ?>"><?php echo $adresse; ?></textarea>
        </div>
		 ...
		 <label for="code_postal">Code Postal</label>
           ...
           <input type="text" placeholder="Code Postal" name="code_postal" value="<?php echo $code_postal; ?>">
        </div>
 ...
 <label for="telephone">Téléphone</label>
           ...
           <input type="tel" maxlength="10" placeholder="Téléphone" name="telephone" value="<?php echo $telephone; ?>">
        </div>
       ...
       <br />
            ...
            <button type="submit" class="button-violet pure-button" name="inscription" value="Inscription">METTRE A JOUR</button>
