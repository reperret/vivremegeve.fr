...
from utilisateur U left outer join renouvellement R on R.idUtilisateur=U.idUtilisateur and R.date between '".$anneeSql."-09-01' and '".$anneeSqlPlus1."-08-31'  
where U.renouvellement=0 and U.paiement=1
...
and
    ...
    or (U.datePaiement  between '".$anneeSql."-09-01' and '".$anneeSqlPlus1."-08-31'   and U.paiement=1) 
...
from utilisateur U left outer join renouvellement R on R.idUtilisateur=U.idUtilisateur and R.date between '".$anneeSql."-09-01' and '".$anneeSqlPlus1."-08-31'  
where U.renouvellement=1 and U.paiement=1
    (
...
function getExports($sql,$dbh)
{
	...
	foreach ($lignes as $colonne)
	{
        ...
        $ligneCommande[]=$colonne->adresse2;
        $enTete[]="adresse2";
        
        $ligneCommande[]=$colonne->code_postal2;
        $enTete[]="code_postal2";
        
        $ligneCommande[]=$colonne->ville2;
        $enTete[]="ville2";
